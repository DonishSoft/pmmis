        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProcurementPlanId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectTasks_AspNetUsers_AssignedById",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProjectTasks_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectTasks_ProcurementPlans_ProcurementPlanId",
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectTasks_WorkProgresses_WorkProgressId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OriginalDueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    NewDueDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Status = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TaskExtensionRequests_AspNetUsers_ApprovedById",
                        column: x => x.ApprovedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_TaskExtensionRequests_AspNetUsers_RequestedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_AssignedById",
                table: "ProjectTasks",
                column: "AssignedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_ContractId",
                table: "ProjectTasks",
                column: "ContractId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_ProcurementPlanId",
                table: "ProjectTasks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTasks_WorkProgressId",
                table: "ProjectTasks",
