        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MessageTj = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Jamoats", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Jamoats_Districts_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Number = table.Column<int>(type: "integer", nullable: false),
                    Households2020 = table.Column<int>(type: "integer", nullable: false),
                    Population2020 = table.Column<int>(type: "integer", nullable: false),
                    HouseholdsCurrent = table.Column<int>(type: "integer", nullable: false),
                    ...
                    IsCoveredByProject = table.Column<bool>(type: "boolean", nullable: false),
                    JamoatId = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    NameRu = table.Column<string>(type: "text", nullable: false),
                    NameTj = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Villages_Jamoats_JamoatId",
                        column: x => x.JamoatId,
                        principalTable: "Jamoats",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BudgetExpenses_BudgetItems_BudgetItemId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IndicatorValues_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_IndicatorValues_Villages_VillageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ScopeOfWorkTj = table.Column<string>(type: "text", nullable: false),
                    ScopeOfWorkEn = table.Column<string>(type: "text", nullable: false),
                    Type = table.Column<int>(type: "integer", nullable: false),
                    ...
                    ExtendedToDate = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    ContractAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    AdditionalAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    SavedAmount = table.Column<decimal>(type: "numeric(18,2)", precision: 18, scale: 2, nullable: false),
                    WorkCompletedPercent = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    ProjectId = table.Column<int>(type: "integer", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Contracts_SubComponents_SubComponentId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompletedPercent = table.Column<decimal>(type: "numeric(5,2)", precision: 5, scale: 2, nullable: false),
                    Description = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkProgresses_Contracts_ContractId",
                        column: x => x.ContractId,
                        principalTable: "Contracts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_Documents_WorkProgresses_WorkProgressId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetExpenses_BudgetItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Contracts_SubComponentId",
                table: "Contracts",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documents_WorkProgressId",
                table: "Documents",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndicatorValues_DistrictId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IndicatorValues_VillageId",
                table: "IndicatorValues",
                column: "VillageId");

            migrationBuilder.CreateIndex(
                name: "IX_Jamoats_DistrictId",
                table: "Jamoats",
                column: "DistrictId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Villages_JamoatId",
                table: "Villages",
                column: "JamoatId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkProgresses_ContractId",
